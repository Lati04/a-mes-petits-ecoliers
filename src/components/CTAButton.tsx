...
const CTAButton: React.FC<CTAButtonProps> = ({
  ...
  switch (variant) {
    ...
    case "button-gold":
      variantClasses =
        "px-3 py-2 text-sm sm:px-2 sm:text-base text-[#2b2100] bg-gradient-to-br from-[#e0af47] to-[#ebce8c] shadow-[0_6px_15px_rgba(224,175,71,0.4)] hover:bg-gradient-to-br hover:from-[#ebce8c] hover:to-[#e0af47] hover:shadow-[0_10px_25px_rgba(224,175,71,0.5)] hover:-translate-y-1 " +
